...
function checkTableName($shortTName )
{
	...
	if ("global_users" == $shortTName )
		return true;
	if ("hoja_ruta_2020_trpn" == $shortTName )
		return true;
	...
	if ("nomina_cont_meses" == $shortTName )
		return true;
	if ("informe_intersup_cxc" == $shortTName )
		return true;
	...
	if ("hoja_ruta_2020_tracking" == $shortTName )
		return true;
	if ("hoja_ruta_event_type" == $shortTName )
		return true;
	if ("contractor_master_jur" == $shortTName )
		return true;
	if ("hoja_ruta_2020_trpn_jur" == $shortTName )
		return true;
	if ("interventor_interno" == $shortTName )
		return true;
	if ("contrato_tipo_unidad" == $shortTName )
		return true;
	if ("hoja_ruta_tparam_conceptos" == $shortTName )
		return true;
	...
	if ("global_documents" == $shortTName )
		return true;
	if ("hoja_ruta_2020_files" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoja_ruta_2020_trpn");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hoja_ruta_2020_trpn";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_cxc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_cxc";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoja_ruta_2020_trpn_jur");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hoja_ruta_2020_trpn_jur";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoja_ruta_tparam_conceptos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hoja_ruta_tparam_conceptos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
...
//	default permissions
	...
	if( $table=="hoja_ruta_2020_trpn_jur" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="hoja_ruta_tparam_conceptos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
