...
{
	$value = "";
				if($table=="contractor_master" && $field=="contractor_medicinapre_file")
	{
		;
		return $value;
	}
				...
				if($table=="global_documents" && $field=="doc_file")
	{
		...
		return $value;
				...
				if($table=="hoja_ruta_2020_files" && $field=="hr_file" && $ptype=="list")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
		...
		if($table=="informe_intersup_oe_contratista" && $field=="sup_aprueba")
	{
		...
		if($table=="hoja_ruta_2020_trpn" && $field=="id_informe_fk")
	{
		$strWhere = " inf_estado = 4 ";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn" && $field=="hr_concepto_id")
	{
		$strWhere = " concepto_id = 38 ";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn" && $field=="evento_type_id_fk")
	{
		$strWhere = " evento_type_id = 19";
		return $strWhere;
	}
		if($table=="informe_intersup_4" && $field=="inf_estado")
	{
		...
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="id_informe_fk")
	{
		$strWhere = " inf_estado = 4 ";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="hr_concepto_id")
	{
		$strWhere = " concepto_id = 5 ";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="sys_user")
	{
		$strWhere = " idusrglobal = 1060 ";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="evento_type_id_fk" && $ptype=="edit")
	{
		$strWhere = " evento_type_id = 21";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="evento_type_id_fk" && $ptype=="add")
	{
		$strWhere = " evento_type_id = 21";
		return $strWhere;
	}
		if($table=="hoja_ruta_2020_trpn_jur" && $field=="evento_type_id_fk" && $ptype=="search")
	{
		$strWhere = " evento_type_id = 21";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="informe_intersup_anexos_contratista" && $field=="anexo_grupo")
	{
		return 8;
				...
				if($table=="hoja_ruta_2020_trpn" && $field=="hr_nit_contra_ta")
	{
		return $_SESSION["UserID"];
	}
				if($table=="hoja_ruta_2020_trpn" && $field=="hr_concepto_id")
	{
		return 38;
				...
				if($table=="hoja_ruta_2020_trpn" && $field=="hr_anio")
	{
		return strftime("%Y");
	}
				if($table=="hoja_ruta_2020_trpn" && $field=="hr_fechaingreso")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="hoja_ruta_2020_trpn" && $field=="sys_fecha_reg")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="hoja_ruta_2020_trpn" && $field=="evento_type_id_fk")
	{
		return 19;
				...
				if($table=="hoja_ruta_2020_trpn" && $field=="user_from")
	{
		return $_SESSION["UserID"];
	}
				if($table=="hoja_ruta_2020_trpn" && $field=="last_act_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_cxc" && $field=="de_pre")
	{
		return "PR";
	}
				if($table=="informe_intersup_cxc" && $field=="cxc_fechaelab")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="informe_intersup_cxc" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_cxc" && $field=="sys_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_cxc" && $field=="sys_status")
	{
		return 0;
	}
				if($table=="informe_intersup_4" && $field=="inf_estado")
				...
				if($table=="contractor_master_jur" && $field=="active")
	{
		return 1;
				...
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="hr_nit_contra_ta")
	{
		return $_SESSION["UserID"];
	}
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="hr_concepto_id")
	{
		return 5;
				...
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="hr_anio")
	{
		return strftime("%Y");
	}
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="hr_fechaingreso")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="sys_fecha_reg")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="evento_type_id_fk" && $ptype=="edit")
				...
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="evento_type_id_fk" && $ptype=="search")
	{
		return 21;
				...
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="user_from")
	{
		return $_SESSION["UserID"];
	}
				if($table=="hoja_ruta_2020_trpn_jur" && $field=="last_act_user")
	{
		return $_SESSION["UserID"];
	}
...
function GetUploadFolderExpression($field, $file, $table )
{
	if($table=="informe_intersup_oe_contratista" && $field=="evidencia")
	{
		$folder = "../GesDoc/Contratos/".$_SESSION["ContID"]."/".$_SESSION["InfID"]."/evidencias";
;
		return $folder;
	}
	return "";
