...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "gestioncontratistas_ver_103_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratistas_ver_103_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratistas_ver_103_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratistas_ver_103_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_contractor_master_OwnerID", $userId );
						...
						storageSet( "_hoja_ruta_2020_trpn_OwnerID", $userId );
						storageSet( "_informe_intersup_cxc_OwnerID", $userId );
						storageSet( "_informe_intersup_4_OwnerID", $userId );
						storageSet( "_contractor_master_jur_OwnerID", $userId );
						storageSet( "_hoja_ruta_2020_trpn_jur_OwnerID", $userId );
		} else {
			...
			storageSet( "_contractor_master_OwnerID", $data["contractor_doc_id"] );
						...
						storageSet( "_hoja_ruta_2020_trpn_OwnerID", $data["contractor_doc_id"] );
						storageSet( "_informe_intersup_cxc_OwnerID", $data["contractor_doc_id"] );
						...
						storageSet( "_hoja_ruta_2020_trpn_jur_OwnerID", $data["contractor_doc_id"] );
		}
	}
