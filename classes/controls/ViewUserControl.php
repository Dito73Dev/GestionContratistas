...
$this->settings["option2"] = 0;;
					...
					if($this->container->tName=="informe_intersup_anexos_contratista" && $this->field=="anexo_file")
		{
			$this->settings["option1"] = "value";
$this->settings["option2"] = 0;;
		}	
					if($this->container->tName=="informe_intersup_4" && $this->field=="hashfirmado")
		{
			$this->settings["option1"] = "value";
$this->settings["option2"] = 0;;
		}	
...
$this->settings["option2"] = 0;;
					...
					if($this->container->tName=="informe_intersup_anexos_contratista_o" && $this->field=="anexo_file")
		{
			$this->settings["option1"] = "value";
$this->settings["option2"] = 0;;
		}	
